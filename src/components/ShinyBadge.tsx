...
const ShinyBadge: React.FC<ShinyBadgeProps> = ({
  title = 'PRODUCT HUNT',
  subtitle = 'Maker of the Year 2025',
}) => {
  const [rotate, setRotate] = useState({ x: 0, y: 0 });
  const [highlightRotation, setHighlightRotation] = useState(15);
